...
public class GameOver extends GameState 
{
    ...
    {
        this.gsm = gsm;
        new ScoreGUI((int)(GamePanel.getScreenWidth()/2),GamePanel.getScreenHeight() - (int)(GamePanel.getScreenHeight()/2) + 50, true);
        playAgainButton = new PlayAgainButton((int)(GamePanel.getScreenWidth()/2 - GamePanel.getScreenWidth()/8), (int)(GamePanel.getScreenHeight()/2) + 250, gsm);
        mainMenuButton = new MainmenuButton((int)(GamePanel.getScreenWidth()/2 + GamePanel.getScreenWidth()/8), (int)(GamePanel.getScreenHeight()/2) + 250, gsm);
