...
public class AnimatedSprite
{
	...
	public void draw(Graphics2D g)
	{
		...
		g.drawImage(op.filter(frames.get(currentFrame), null), transform.getPositionX() - width * 3 / 2 * GamePanel.getWidthScaleFactor(),
				transform.getPositionY() - height * 3 / 2 * GamePanel.getHeightScaleFactor(), width * 3 * GamePanel.getWidthScaleFactor(), height * 3 * GamePanel.getHeightScaleFactor(), null);
	}
