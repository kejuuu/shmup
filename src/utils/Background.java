...
public class Background extends GameObject {
    ...
    public void draw(Graphics2D g) {
        g.drawImage(image, transform.positionX, transform.positionY, GamePanel.SCREEN_WIDTH, GamePanel.SCREEN_HEIGHT, null);

        if (transform.positionY >= 0) {
            g.drawImage(image, 0, transform.positionY - GamePanel.SCREEN_HEIGHT, GamePanel.SCREEN_WIDTH, GamePanel.SCREEN_HEIGHT, null);
