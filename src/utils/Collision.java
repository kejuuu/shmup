...
public class Collision
{
    ...
    {
        Rectangle ra = new Rectangle(a.transform.positionX - a.image.getWidth() * 3 / 2 * GamePanel.getScreenWidth() / 1920, 
        ...
        Rectangle rb = new Rectangle(b.transform.positionX - b.image.getWidth() * 3 / 2 * GamePanel.getScreenWidth() / 1920, 
    ...
    public static boolean checkMousePosition(Button button, int x, int y) {
    	if(x > button.transform.positionX - button.image.getWidth() * 3 / 2  * GamePanel.getScreenWidth() / 1920 && 
                ...
                y > button.transform.positionY - button.image.getHeight() * 3 / 2 * GamePanel.getScreenHeight() / 1080 && 
                y < button.transform.positionY + button.image.getHeight() * 3 / 2 * GamePanel.getScreenHeight() / 1080)
        {
            return true;
        }
